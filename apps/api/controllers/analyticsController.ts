...
// @access  Private/Admin
const getProductAnalytics: RequestHandler = asyncHandler(async (req: RequestWithQuery<ProductAnalyticsQuery>, res) => {
  try {
    const {
      page = "1",
      limit = "20",
...
// @access  Private/Admin
const getSalesAnalytics: RequestHandler = asyncHandler(async (req: RequestWithQuery<SalesAnalyticsQuery>, res) => {
  try {
...
// @access  Private/Admin
const getInventoryAlerts: RequestHandler = asyncHandler(async (req: RequestWithQuery<InventoryAlertsQuery>, res) => {
  try {
